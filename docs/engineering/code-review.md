[Source](https://github.com/gn0rt0n/skills/tree/main/skills/engineering/code-review)
...
Its closest neighbour is [implement](./implement.md), which drives the build and calls this as its own review pass before committing; upstream, the spec it checks against is produced by [to-spec](./to-spec.md) and [to-tickets](./to-tickets.md). When you're unsure which skill or flow fits, [which-skill](./which-skill.md) routes you.
