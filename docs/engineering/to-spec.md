[Source](https://github.com/gn0rt0n/skills/tree/main/skills/engineering/to-spec)
...
`to-spec` publishes into your issue tracker, so [setup-gn0rt0n-skills](./setup-gn0rt0n-skills.md) must have configured the tracker and triage labels for this repo first. It applies the `ready-for-agent` label itself — no separate triage pass needed.
